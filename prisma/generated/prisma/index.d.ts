...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'chef' | 'menu' | 'menuItem' | 'ingredient' | 'supplier' | 'location' | 'supplierLocation' | 'supplierIngredient' | 'order' | 'orderItem' | 'review'
  ...
  export interface SupplierLocationDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * const supplierLocationWithSupplierIdOnly = await prisma.supplierLocation.findMany({ select: { supplierId: true } })
     * 
    **/
  ...
  export interface SupplierIngredientDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
     * // Only select the `supplierId`
     * const supplierIngredientWithSupplierIdOnly = await prisma.supplierIngredient.findMany({ select: { supplierId: true } })
     * 
    **/
  ...
  export type IngredientWhereInput = {
    ...
    menuItemId?: StringFilter<"Ingredient"> | string
  ...
  export type IngredientScalarWhereWithAggregatesInput = {
    ...
    menuItemId?: StringWithAggregatesFilter<"Ingredient"> | string
  ...
  export type SupplierIngredientWhereUniqueInput = Prisma.AtLeast<{
    ...
    ingredient?: XOR<IngredientRelationFilter, IngredientWhereInput>
    location?: XOR<LocationRelationFilter, LocationWhereInput>
  }, "supplierId_ingredientId_locationId">
